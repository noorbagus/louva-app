  ...
  return (
    <div className="min-h-screen bg-[var(--surface)]">
      ...
      <div className="max-w-md mx-auto px-5 py-6 space-y-6">
        {loading || !customer ? (
          // Loading skeleton for QR page content
          <div className="space-y-6">
            <div className="animate-pulse">
              <div className="relative rounded-2xl p-4 bg-gradient-to-r from-blue-500/30 to-blue-400/30 h-80">
                <div className="h-6 bg-white/20 rounded w-32 mb-4"></div>
                <div className="h-10 bg-white/20 rounded w-48 mb-4"></div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-white/95 text-xs font-medium mb-1 tracking-wide">{customer.membership_level}</div>
